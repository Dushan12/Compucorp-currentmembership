...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://dushan:password@localhost/drupal_test?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://dushan:password@localhost/civicrm_test?new_link=true');
  }
}
...
$civicrm_root = '/home/dushan/Compucorp/web/drupal/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/dushan/Compucorp/web/drupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '488def0bdcbbb9b8fc64e257a52486f0');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/dushan/Compucorp/web/drupal/sites/default/files/civicrm/templates_c//mail.log');
// }
